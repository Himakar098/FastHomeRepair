...
OPENAI_API_KEY=<optional-api-key-if-not-using-managed-identity>
OPENAI_API_BASE=https://<your-azure-openai-resource>.cognitiveservices.azure.com
OPENAI_DEPLOYMENT_NAME=gpt-5-nano
OPENAI_API_VERSION=2025-01-01-preview
OPENAI_USE_AAD=true  # set to true when using a managed identity instead of an API key
